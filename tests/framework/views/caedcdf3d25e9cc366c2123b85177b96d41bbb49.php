...
<div class="container-fluid">
    ...
    <div class="rounded shadow-sm p-3" style="background-color:rgba(167, 214, 255, 0.356);">
        <div class="border-bottom py-4"><h4>Complemento do chamado - ID <?php echo e($data['id']); ?></h4></div>
        <div class="border-bottom py-4"><?php echo $data['complemento'] ?></div>
        <div class="pt-3"><p class="text-muted">Enviado por <?php echo e($data['nome']); ?></p></div>
    </div>
</div>
<?php /**PATH C:\laragon\www\Bugs\resources\views/sender/mailLupa.blade.php ENDPATH**/ ?>