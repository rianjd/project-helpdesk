...
<div class="container">
    <section class="contact-page-section">
        <div class="container">
                <div class="sec-title">
                    <div class="title"><img src="images/corebusiness_1200x300.png" width="130" height="30" class="d-inline-block align-top m-1" alt=""></div>
                    <h2 style="color: rgb(43, 43, 43);">Ajuste login Core <i class="bi bi-nut-fill" style="margin-left:20px; color:green;"></i></h2>
                </div>
                    ...
                    <!--Form Column-->
                                ...
                                <div class="contact-form">
                                    ...
                                    <?php echo e(csrf_field()); ?>
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="form-group col-md-12 col-sm-6 co-xs-12 mt-4">
                                                <input  type="text" name="user" id="user" required placeholder="Login core">
                                            </div>
                                            ...
                                            <div class="form-group col-md-12 col-sm-12 co-xs-12 mt-4">
                                                <textarea name="msg" id="msg" placeholder="Alterações para serem realizadas."></textarea>
                                            </div>
                                            <div class="form-group col-md-12 col-sm-12 co-xs-12 mt-4">
                                        ...
                                        <input type="hidden" id="tipo" name="ajuste" value="Ajuste">
                                        <input type="hidden" id="tipo_chamado" name="tipo_chamado" value="Core">
                                        <input type="hidden" id="categoria" name="categoria" value="Ajuste">
                                    </form>
                                </div>
                                <!--End Contact Form-->
                        ...
                        <div class="info-column col-md-4 col-sm-12 col-xs-12">
                            <div class="inner-column">
                                <h2>Info</h2>
                                <ul class="list-info">
                                    <li><i class="bi bi-exclamation-diamond ml-1" style="color: rgb(211, 175, 14);"></i> <p class="mb-3">Esse formulário é designado apenas para AJUSTE de login Core</p></li>
                                    <li><i class="bi bi-exclamation-diamond ml-1" style="color: rgb(211, 175, 14);"></i> <p class="mb-3">Caso deseje realizar a criação de um novo login <a href="/core">clique aqui</a></p></li>
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Bugs\resources\views/ajuste/coreforms.blade.php ENDPATH**/ ?>