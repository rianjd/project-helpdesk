...
<div class="container">
    <section class="contact-page-section">
        <div class="container">
                <div class="sec-title">
                    <div class="title"><img src="images/lupa.jpg" width="60" height="60" class="d-inline-block align-top m-1" alt=""></div>
                    <h2 style="color: rgb(43, 43, 43);">Chamado LUPA <i class="bi bi-node-plus-fill" style="margin-left:20px; color:rgb(109, 128, 0);"></i></h2>
                </div>
                    ...
                    <!--Form Column-->
                        <div class="form-column col-md-8 col-sm-12 col-xs-12">
                            ...
                            <!--Contact Form-->
                                <div class="contact-form">
                                    <form action="<?php echo e(route('lupa_post')); ?>" method="post" id="contact-form" enctype="multipart/form-data">
                                    <?php echo e(csrf_field()); ?>
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="form-group col-md-6 col-sm-6 co-xs-12  mt-4">

                                                <input type="text" name="contato" value="" placeholder="Contato no local " required>
                                            </div>
                        ...
                        <div class="info-column col-md-4 col-sm-12 col-xs-12">
                            <div class="inner-column">
                                <h2>Info</h2>
                                <ul class="list-info">
                                    <li><i class="bi bi-exclamation-diamond ml-1" style="color: rgb(211, 175, 14);"></i> <p class="mb-3">Chamados internos enviados diretamente para LUPA</p></li>
                                    <li><i class="bi bi-exclamation-diamond ml-1" style="color: rgb(211, 175, 14);"></i> <p class="mb-3">Para abrir um chamado apenas interno <a href="/interno">clique aqui</a></p></li>

                                    <li><i class="bi bi-exclamation-diamond ml-1" style="color: rgb(211, 175, 14);"></i> <p class="mb-3">De o maximo de detalhes sobre a solicitação</p>
                                    </li>
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Bugs\resources\views/lupa_form.blade.php ENDPATH**/ ?>