                        ...
                        <!--Form Column-->
                          <div class="form-column col-md-8 col-sm-12 col-xs-12">
                            <div class="inner-column">
                                  ...
                                  <div class="contact-form">
                                      <form enctype="multipart/form-data" action="<?php echo e(route('chamados.store')); ?>" method="post" id="contact-form" enctype="multipart/form-data">
                                        <?php echo e(csrf_field()); ?>

                                          <div class="row clearfix">
                                              <div class="form-group col-md-6 col-sm-6 co-xs-12">

                                                  <input  type="text" name="nome" id="nome" required placeholder="Nome solicitante ">
                                              </div>
                                              <div class="form-group col-md-6 col-sm-6 co-xs-12">
                                              ...
                                              <div class="form-group col-md-4 col-sm-6 co-xs-12 mt-4">
                                                <label for="tipo" class="col-form-label sans text-muted">Tipo </label>
                          ...
                          <div class="info-column col-md-4 col-sm-12 col-xs-12">
                            <div class="inner-column">
                                <h2>Info</h2>
                                  <ul class="list-info">
                                    <li><i class="bi bi-exclamation-diamond ml-1" style="color: rgb(211, 175, 14);"></i> <p class="mb-3 ">Esse formulário <strong>NÃO</strong> é designado para solicitações relacionadas ao Core</p></li>
                                    <li><i class="bi bi-exclamation-diamond ml-1" style="color: rgb(211, 175, 14);"></i> <p class="mb-3 " >Todos os campos são obrigatórios</p>
                                    </li>
                                    <li><i class="bi bi-exclamation-diamond ml-1" style="color: rgb(211, 175, 14);"></i> <p class="mb-3 ">Descrever o maximo de detalhes sobre a sua solicitação</p></li>
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Bugs\resources\views/chamado.blade.php ENDPATH**/ ?>