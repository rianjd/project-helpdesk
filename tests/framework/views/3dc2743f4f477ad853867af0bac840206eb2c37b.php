    ...
    <body style="background-color: rgb(250, 250, 250) ">
        <nav class="navbar navbar-light navbar-expand-lg shadow-sm sticky-top" style=" padding:.4em 3em; background-color:rgb(255, 255, 255);">
            <a class="navbar-brand" href="#">
                <img class="logomarca" src="<?php echo e(URL::asset('images/logo-novo.png')); ?>" width="160">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                <ul class="navbar-nav" style="font-family: Chivo; font-size:17px;">
                    ...
                    <li class="nav-item">
                        <div class="dropdown">
                        <a class="nav-link mr-5 dropdown-toggle" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" >Chamados</a>
                        <div class="dropdown-menu " aria-labelledby="dropdownMenuButton">
                            <p class="dropdown-item disabled" style="color: rgb(54, 54, 54)"><strong>Chamados</strong></p>
                            <a class="dropdown-item" href="/chamado">Assistencia TI</a>
                            <a class="dropdown-item"  data-toggle="modal" data-target="#modalCore">Core</a>
                            <a class="dropdown-item" href="/email">Email</a>
                            <a class="dropdown-item" href="/chat">Chat</a>
                            <?php if(Auth::check() and Auth::user()->comment !== null): ?>
                                <a class="dropdown-item" href="/lupa">Lupa</a>
                                <a class="dropdown-item" href="/interno">Interno</a>
                             <?php endif; ?>
                        </div>
                    </div>
                    </li>
                    ...
                    <li class="nav-item ">
                        <a class="nav-link mr-5" href="/getChamado">Acompanhamento</a>
                    </li>
                    <?php if(Auth::check() and Auth::user()->comment !== null): ?>
                    <li class="nav-item ">
                        <a class="nav-link mr-5" href="/admin/dashboard">Admin</a>
                    </li>
            ...
            <?php if( Auth::check() ): ?>
                ...
                <div class="dropleft">
                    <?php if(Auth::user()->locations_id == 0): ?>
                    <a class="nav-link dropdown-toggle" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" ><img src="storage/profile/<?php echo e(Auth::user()->comment); ?>.jpg" width="40" height="40" style="border-radius: 50%;" alt="Sair"></a>
                    <?php else: ?>
                    ...
                    <?php endif; ?>
                    <div class="dropdown-menu " aria-labelledby="dropdownMenuButton">
                        <p class="dropdown-item disabled" style="color: rgb(54, 54, 54)"><strong><?php echo e(Auth::user()->name); ?></strong></p>
                        <?php if(Auth::user()->comment !== null): ?> <a class="dropdown-item" href="/perfil">Ver perfil</a> <?php else: ?> <a class="dropdown-item disabled" href="/perfil">Ver perfil</a><?php endif; ?>
        ...
        <div class="modal fade" id="modalCore" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    <h4 class="modal-title" id="exampleModalLabel"><img src="<?php echo e(URL::asset('images/corebusiness_1200x300.png')); ?>" width="120" height="30" class="align-top mt-1 mr-2" alt="">
                        Solicitações</h4>
...
<?php /**PATH C:\laragon\www\Bugs\resources\views/welcome.blade.php ENDPATH**/ ?>