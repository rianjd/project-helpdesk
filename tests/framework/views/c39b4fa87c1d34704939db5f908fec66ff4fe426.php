    ...
    <section class="contact-page-section">
        <div class="container">
                <div class="sec-title">
                    ...
                    <h2 style="color: rgb(43, 43, 43);">Novo login DJ <i class="bi bi-person-plus-fill" style="margin-left:20px; color:rgb(19, 200, 224);"></i></h2>
                </div>
                                ...
                                <div class="contact-form">
                                    ...
                                    <?php echo e(csrf_field()); ?>
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="form-group col-md-6 col-sm-6 co-xs-12">
                                                <input  type="text" name="user" id="user" required placeholder="Usuario do Core">
                                            </div>
                        ...
                        <div class="info-column col-md-4 col-sm-12 col-xs-12">
                            <div class="inner-column">
                                ...
                                <ul class="list-info">
                                    ...
                                    <li><i class="bi bi-exclamation-diamond ml-1" style="color: rgb(211, 175, 14);"></i> <p class="mb-3">Caso deseje realizar um ajuste em um usuário já existente <a href="/djajuste">clique aqui</a></p></li>
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Bugs\resources\views/dj.blade.php ENDPATH**/ ?>