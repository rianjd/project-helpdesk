...
<div class="container-sm">
        ...
        <div class="col-md-6 mb-5">
            <div class="card pl-5 pr-5" style="box-shadow: 2px 3px 9px #b9b8b8;" >
                <div class="form p-5">
                    ...
                    <form class="mb-5" action="<?php echo e(route('help.store')); ?>" method="post" id="tipo" name="tipo" selected="chatForm">
    ...
    <div class="text-center p-4" style="background-color: rgba(253, 253, 253, 0.05);">
        <footer >
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Bugs\resources\views/suporte.blade.php ENDPATH**/ ?>