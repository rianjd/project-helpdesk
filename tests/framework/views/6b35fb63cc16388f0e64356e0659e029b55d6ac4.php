            ...
            <div class="my-3 p-3 bg-white rounded shadow-sm" >
                ...
                <?php if(isset($data['msg'])): ?>
                        <div class="media-body pb-3 my-3 med lh-125 border-bottom border-gray" style="font-size: 23px;">
                            <?php echo $data['msg']; ?>
                            <p><br/>Atenciosamente, <br/><strong><?php echo e($data['nome']); ?></strong></p>
                ...
                <?php if(isset($data['nome'])): ?>
                    <div class="media-body p-3 my-2 med lh-125 border-gray text-center" style="font-size: 18px; margin-bottom:0; "><p><strong>Enviado em: </strong></p><?php echo e($data['time']); ?></div><?php endif; ?>
...
<?php /**PATH C:\laragon\www\Bugs\resources\views/sender/mailAcomp.blade.php ENDPATH**/ ?>