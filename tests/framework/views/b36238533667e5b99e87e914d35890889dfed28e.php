...
<div class="container">
    <section class="contact-page-section">
        <div class="container">
                <div class="sec-title">
                    <div class="title"><img src="images/corebusiness_1200x300.png" width="130" height="35" class="d-inline-block align-top m-1" alt=""></div>
                    <h2 style="color: rgb(43, 43, 43);">Novo Login <i class="bi bi-person-plus-fill" style="margin-left:20px; color:green;"></i></h2>
                </div>
                        ...
                        <div class="form-column col-md-8 col-sm-12 col-xs-12">
                            ...
                            <!--Contact Form-->
                                <div class="contact-form">
                                    <form action="<?php echo e(route('chamados.store')); ?>" method="post" id="contact-form" enctype="multipart/form-data">
                                    <?php echo e(csrf_field()); ?>
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="form-group col-md-4 col-sm-6 co-xs-12 mt-4">
                                                ...
                                                <label for="funcao" class="col-form-label sans text-muted">Grupo</label>
                                                <select class="form-control" name="funcao" required="">
                                                    <option value="">...</option>
                                                    <option>Administrativo (Matriz)</option>
                                                    <option>Logística Depósito</option>
                                                    <option>Logística Entregas</option>
                                                    <option>Logística Frota</option>
                                                    <option>Vendas</option>
                                                    <option>Caixa</option>
                                                    <option>Pacote/Reposição</option>
                                                    <option>Gerente</option>
                                                    <option>Aux Crédito e Cobrança</option>
                                                    <option>Ass Crédito e Cobrança</option>
                                                    <option>Chefia Crédito e Cobrança</option>
                                                    <option>Líder Logístico</option>
                                                    <option>Auxiliar Logístico</option>
                                                    <option>Auxiliares de Depósitos</option>
                                                    <option>Conferente</option>
                                                    <option>Líder de Depósito</option>
                                                    <option>Vendas/Treinamento </option>
                                                    <option>Compras</option>

                                                </select>
                                            </div>
                                            <div class="form-group col-md-12 col-sm-12 co-xs-12 mt-4">
                                                <textarea name="msg" id="msg" placeholder="Ex: Clonar usuário, permissão adicional, login temporário..."></textarea>
                                            </div>
                                        ...
                                        <input type="hidden" id="tipo_chamado" name="tipo_chamado" value="Core">
                                        <input type="hidden" id="categoria" name="categoria" value="Solicitação">
                        ...
                        <div class="info-column col-md-4 col-sm-12 col-xs-12">
                            <div class="inner-column">
                                ...
                                <ul class="list-info">
                                    ...
                                    <li><i class="bi bi-exclamation-diamond ml-1" style="color: rgb(211, 175, 14);"></i> <p class="mb-3">Caso deseje realizar um ajuste em um usuário já existente <a href="/coreajuste">clique aqui</a></p></li>
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Bugs\resources\views/acessorios.blade.php ENDPATH**/ ?>