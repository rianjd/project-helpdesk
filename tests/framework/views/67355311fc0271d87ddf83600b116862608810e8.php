                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-md-6 ">
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form-control" type="email" name="email" value="<?php echo e($chamado['email']); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6 ">
                                        <div class="form-group mb-3">
...
<?php /**PATH C:\laragon\www\Bugs\resources\views/admin/modal/solucao.blade.php ENDPATH**/ ?>