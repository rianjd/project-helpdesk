...
<div class="container">
    <section class="contact-page-section">
        <div class="container">
                <div class="sec-title">
                    <div class="title"><img src="images/djpdv.png" width="130" height="30" class="d-inline-block align-top m-1" alt=""></div>
                    <h2 style="color: rgb(43, 43, 43);">Ajuste login DJ <i class="bi bi-nut-fill" style="margin-left:20px; color:rgb(14, 177, 226);"></i></h2>
                </div>
                    ...
                    <!--Form Column-->
                                    ...
                                    <?php echo e(csrf_field()); ?>
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="form-group col-md-12 col-sm-6 co-xs-12">
                                                <input  type="text" name="user" id="user" required placeholder="User DJ">
                                            </div>
                        ...
                        <div class="info-column col-md-4 col-sm-12 col-xs-12">
                            <div class="inner-column">
                                <h2>Info</h2>
                                <ul class="list-info">
                                    <li><i class="bi bi-exclamation-diamond ml-1" style="color: rgb(211, 175, 14);"></i> <p class="mb-3">Esse formulário é designado apenas para AJUSTE de login DJ</p></li>
                                    <li><i class="bi bi-exclamation-diamond ml-1" style="color: rgb(211, 175, 14);"></i> <p class="mb-3">Caso deseje realizar a criação de um novo login <a href="/dj">clique aqui</a></p></li>
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Bugs\resources\views/ajuste/djforms.blade.php ENDPATH**/ ?>