        ...
        <div class="my-3 p-3 bg-white rounded shadow-sm">
            <h3 class="border-bottom border-gray pb-4 mb-0">
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                    class="bi bi-check-circle mr-3" style="font-size: 23px; color:rgb(8, 156, 8);" viewBox="0 0 16 16">
                    <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
                    <path
                        d="M10.97 4.97a.235.235 0 0 0-.02.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-1.071-1.05z" />
                </svg>Chamado solucionado!
            </h3>
                ...
                <div class="media-body pb-3 my-3 med lh-125 border-bottom border-gray" style="font-size: 23px;">
                    ...
                    <p>Atenciosamente, <br /><strong>{{ $data['nome'] }}</strong></p>
                </div>

            @if (isset($data['nome']))
                <div class="media-body p-3 my-2 med lh-125 border-gray text-center"
                    style="font-size: 18px; margin-bottom:0; ">
                    <p><strong>Finalizado em: </strong></p>{{ $data['time'] }}
                </div>
            @endif
        </div>
        <div class="my-3 p-3 rounded shadow-sm  text-muted" style="background-color: #f0fbff ">
            <h4 class="border-bottom border-gray pb-4 mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="30"
                    height="30" fill="currentColor" class="bi bi-info-circle mr-3" viewBox="0 0 16 16">
                    <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
                    <path
