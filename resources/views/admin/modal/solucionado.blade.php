                        ...
                        <div class="row m-2"  id='teste' name="teste">
                            <div class="col-2 media  "  style="align-items: center;">
                                <div class="media-body">
                                    <img src="storage/profile/{{$solu['users_id']}}.jpg" class="mr-3" width="50" height="50" style="border-radius: 50%;" alt="...">
                                    <h5 class="mt-0">{{$tec[$solu['users_id']]}}<i class="bi bi-chat-left-dots ml-2" style="color: rgb(95, 95, 95);"></i></h5>

                                    <span class="text-muted">{{date('d/m/20y', strtotime($solu['date_creation'])) }}<span>
                                </div>
                            </div>

                            <div class="col-9 text-left alert alert-success m-3">
                                <p class="mb-3 ">{!! html_entity_decode($solu['content'])!!}</p>
